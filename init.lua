...
--  NOTE: Use ALT+h/j/k/l instead with tmux navigator
...
require('lazy').setup({
  ...
  -- make tmux panes and vim splits coexist nicely
  {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<C-p>', builtin.git_files, { desc = '[P]review git files' })
